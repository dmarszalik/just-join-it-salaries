...
# job_offer_url = "https://justjoin.it/offers/crimson-panda-sql-data-engineer"
...
# pred = model_from.predict(processed_offer)
...
def prediction(request):
    if request.method == 'POST':
        ...
        offer_instance.preprocess()
        processed_offer = offer_instance.get_processed_offer()
    salary_from = round(model_from.predict(processed_offer)[0]/100)*100
    salary_to = round(model_to.predict(processed_offer)[0]/100)*100
